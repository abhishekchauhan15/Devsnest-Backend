...
//node js requires absolute path to the file    
...
// app.use('/', (req, res)=>{
//     //all the files which can be rendered by browser that is rendered by sendfile 
//     // res.sendFile(path.join(__dirname, 'public/text.txt'), 'hello.txt')

//     //to download the stuff
//     res.download(path.join(__dirname, 'public/text.txt'), 'hello.txt')
